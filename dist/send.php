...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
  ...
  $headers[] = 'From: Citizen Home <contato@citizen.com.br>';
  $headers[] = 'Reply-To: '.$nome.'<'.$email.'>';
  $headers[] = 'Cc: Cleane <cleane.eloi@partini.com.br>';
  $headers[] = "X-Mailer: PHP/".phpversion();

  mail('joaopaulo@gplincorporadora.com.br', $subject, $body, $headers);
  exit;
